...
std::vector<unsigned char> SmartHomeProtocol::Pack(std::string const& a_deviceID, std::chrono::system_clock::time_point const& a_timeStamp, std::vector<std::string> const& a_payload) const 
{ 
...
size_t SmartHomeProtocol::UnPackSize(std::vector<unsigned char>& a_packedBuffer) const
{ 
    size_t finalsize; 
    size_t sizeOfElement = sizeof(size_t);
...
std::vector<std::string> SmartHomeProtocol::UnPack(std::vector<unsigned char>& a_packedBuffer) const 
{ 
    ...
    //std::cout << "size dataSizeDeviceID in SmartHomeProtocol : " << dataSizeDeviceID << '\n';
    //std::cout << "size dataSizeTimeStamp in SmartHomeProtocol : " << dataSizeTimeStamp << '\n';
    //std::cout << "size dataSizeVector in SmartHomeProtocol : " << dataSizeVector << '\n';
